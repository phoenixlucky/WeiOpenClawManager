...
- 增加“打开 ClawHub 官网”按钮，直接打开 `https://clawhub.ai/`
- 增加 ClawHub 包安装区域，支持输入包名后执行 `clawhub install <包名>`
- 安装过程改为弹窗实时展示输出日志和进度
- 新增 `POST /api/clawhub/install` 流式安装接口

### 界面与体验

- 主界面整体间距、卡片内边距、按钮与输入框尺寸进一步收紧
- 日志区、进度弹窗和编辑区尺寸下调，提升信息密度

### 版本与文档

- 项目版本号从 `1.4.0` 升级到 `1.5.0`
